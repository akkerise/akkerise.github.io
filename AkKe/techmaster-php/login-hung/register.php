    ...
    <div class="container">
        ...
        <div class="card">
            <form action="checkregister.php" method="post">
                ...
                <div class="input-container">
                    <input type="email" id="Email" name="email" required="required" value="<?php isset($_SESSION['email'])? print_r($_SESSION['email']) : ""; ?>"/>
                    <label for="email">Email</label>
                    <div class="bar"></div>
                    <div class="error"><?php isset($_SESSION['error_validate_email'])? print_r($_SESSION['error_validate_email']) : ""; ?>
                    </div>
                </div>
