...
function ADM_TrackingSendChk(){
	...
	if(__ADMisActive==1 || (tkTime-__ADMTimeTk)>=120){
		__ADMTimeTk=tkTime;
		var img =new Image();
		img.src=window['__ADMTrackingSendUrl']+'&i='+encodeURIComponent('p;'+__admPageloadid+';'+__ADMScrollcounter+';'+__ADMScrollEnd+';'+__ADMisActive+';'+__ADMMouse+';'+__ADMTouch+';'+(wPrototype.wdWidth()+'x'+wPrototype.wdHeight())+';'+window['__ifr']+';'+(typeof(ADS_CHECKER)=='undefined'?0:1)+';'+__admloadPageId+';'+__admloadPageIdc)+ADM_AdsTracking.getParam();
	}
	if(_admBrV<999){
...
function ADM_TrackingSend(){
	...
	url="//lg1.logging.admicro.vn/_tracking1.gif?dg="+__admloadPageIdc;
	...
	if("undefined" != typeof _ADM_Channel && "" != _ADM_Channel){
	...
	url+='&i='+encodeURIComponent('s;'+__admPageloadid+';0;0;'+__ADMisActive+';'+__ADMMouse+';'+__ADMTouch+';'+(wPrototype.wdWidth()+'x'+wPrototype.wdHeight())+';'+window['__ifr']+';'+(typeof(ADS_CHECKER)=='undefined'?0:1)+';'+__admloadPageId+';'+__admloadPageIdc)+'&rdm='+Math.random();
	var imgtk=new Image();
	imgtk.src=window['__ADMTrackingSendUrl']+'&i='+ encodeURIComponent('v;'+__admPageloadid+';'+window['__ADMScrollcounter']+';'+window['__ADMScrollEnd']+';'+__ADMisActive+';'+__ADMMouse+';'+__ADMTouch+';'+(wPrototype.wdWidth()+'x'+wPrototype.wdHeight())+';'+window['__ifr']+';'+(typeof(ADS_CHECKER)=='undefined'?0:1)+';'+__admloadPageId+';'+__admloadPageIdc)+'&rdm='+Math.random()+ADM_AdsTracking.getParam();
	...
	window.setTimeout(function(){
		var stateKey, eventKey,stateKeyuse='', keys = {
				hidden: "visibilitychange",
				webkitHidden: "webkitvisibilitychange",
				mozHidden: "mozvisibilitychange",
				msHidden: "msvisibilitychange"
		...
		document.addEventListener(eventKey, function(){
			...
			var img=new Image();
			img.src=window['__ADMTrackingSendUrl']+'&i='+ encodeURIComponent('p;'+__admPageloadid+';'+__ADMScrollcounter+';'+__ADMScrollEnd+';'+__ADMisActive+';'+__ADMMouse+';'+__ADMTouch+';'+(wPrototype.wdWidth()+'x'+wPrototype.wdHeight())+';'+window['__ifr']+';'+(typeof(ADS_CHECKER)=='undefined'?0:1) +';'+__admloadPageId+';'+__admloadPageIdc)+'&rdm='+Math.random()+ADM_AdsTracking.getParam();
			
		});
	},5000);
	window.setTimeout(function(){ADM_TrackingSendChk();},20000);
	if(('beforeunload' in window) || ('onbeforeunload' in window)){
		if (navigator.userAgent.indexOf("Firefox")!=-1){
			admaddEventListener(window,'unload',function(){
				var img =new Image();
				img.src=window['__ADMTrackingSendUrl']+'&i='+ encodeURIComponent('e;'+__admPageloadid+';'+window['__ADMScrollcounter']+';'+window['__ADMScrollEnd']+';'+__ADMisActive+';'+__ADMMouse+';'+__ADMTouch+';'+(wPrototype.wdWidth()+'x'+wPrototype.wdHeight())+';'+window['__ifr']+';'+(typeof(ADS_CHECKER)=='undefined'?0:1)+';'+__admloadPageId+';'+__admloadPageIdc)+'&rdm='+Math.random()+ADM_AdsTracking.getParam();
			});
		}
		else{
